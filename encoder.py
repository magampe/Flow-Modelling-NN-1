...
class GeoContextData(Dataset):
    ...
    def __init__(self, csv_path, img_dir, transform=None):
        ...
        self.all_data = torch.empty((img_count,10,224,224))
...
class CNNAutoencoder(nn.Module):
    def __init__(self, hidden_dim = 128):
        ...
        self.encoder = nn.Sequential(
            ...
            nn.Conv2d(10, 64, 9, 1, 0), # input dim: (3, 224, 224); next dim: (64, 215, 215)
            nn.ReLU(True),
            ...
            # Final encoded image size (batch first): torch.Size([1, 128, 106, 106])

            # torch.nn.Linear(106*106*128, hidden_dim),
            # nn.ReLU()
        ...
        self.decoder = nn.Sequential(
            # nn.Linear(hidden_dim, 106*106*128),
            # nn.ReLU(),
            ...
            nn.Conv2d(64, 10, 9, stride=1, padding=4),
            nn.Tanh(),  
        )
